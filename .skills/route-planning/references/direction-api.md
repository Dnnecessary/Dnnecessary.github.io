...
| third_part_domain | `app-byyhgn8k5lhd-api-GaDwZKpJxXOY-gateway.appmiaoda.com` |

| 接口 | API ID | Endpoint |
|------|--------|---------|
| 驾车路线规划 | `api-GaDwZKpJxXOY` | `GET https://app-byyhgn8k5lhd-api-GaDwZKpJxXOY-gateway.appmiaoda.com/direction/v2/driving` |
| 骑行路线规划 | `api-W9z3MpAdKeNL` | `GET https://app-byyhgn8k5lhd-api-W9z3MpAdKeNL-gateway.appmiaoda.com/direction/v2/riding` |
| 步行路线规划 | `api-wLNdomNRn42a` | `GET https://app-byyhgn8k5lhd-api-wLNdomNRn42a-gateway.appmiaoda.com/direction/v2/walking` |
| 公交路线规划 | `api-m9xKXQkOKZXa` | `GET https://app-byyhgn8k5lhd-api-m9xKXQkOKZXa-gateway.appmiaoda.com/direction/v2/transit` |
...
async function planRoute(
  ...
  const url = `https://${apiId}@app-byyhgn8k5lhd-api-GaDwZKpJxXOY-gateway.appmiaoda.com/direction/v2/${mode}?${params.toString()}`;
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl =
    `https://${apiId}@app-byyhgn8k5lhd-api-GaDwZKpJxXOY-gateway.appmiaoda.com/direction/v2/${mode}?${params.toString()}`;
