...
- **Endpoint**：`POST https://app-byyhgn8k5lhd-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area`
...
async function queryMobileLocation(
  ...
  const url = new URL("https://app-byyhgn8k5lhd-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstreamUrl = new URL("https://app-byyhgn8k5lhd-api-ELbWz8OmB58Y-gateway.appmiaoda.com/mobile/area");
