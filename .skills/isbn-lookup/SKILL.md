...
- **Endpoint**：`POST https://app-byyhgn8k5lhd-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-byyhgn8k5lhd-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
