...
export const CardStyleEngine: React.FC<CardStyleEngineProps> = ({ styles }) => {
  ...
  const blockquoteCSS = useMemo(() => {
    ...
    .card-render blockquote p { color: ${sc(styles.blockquoteText ?? styles.textColor)} !important; font-style: normal !important; margin: 0 !important; }`
      : `
    .card-render blockquote { border: none !important; position: relative; padding: 12px 16px 12px 22px !important; margin: 10px 0 !important; background: ${blockquoteBg} !important; border-radius: 8px !important; }
